    ...
    <div class="bg-surface-2 rounded-lg shadow-md border border-default overflow-hidden">
        <div class="p-6">
            <div class="text-center mb-6">
                <h1 class="text-2xl font-bold text-foreground">{{ __('Confirm Password') }}</h1>
            ...
            <div class="text-center mt-6">
                <a href="{{ route('password.request') }}" class="text-primary hover:underline font-medium">{{ __('Forgot your password?') }}</a>
            </div>
        </div>
    </div>
</x-layouts.auth>
