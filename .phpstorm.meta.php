...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/chrisganzert/PhpstormProjects/Pflanzen/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/chrisganzert/PhpstormProjects/Pflanzen/public/storage','logging.default','logging.deprecations.channel',
...
'debugbar.queries.explain','home','dashboard','settings.profile.edit',
'settings.profile.update','settings.profile.destroy','settings.password.edit','settings.password.update','settings.appearance.edit',
'register','login','password.request',
'password.email','password.reset','password.store','verification.notice','verification.store',
'verification.verify','password.confirm','confirmation.store','logout','storage.local',);
        registerArgumentsSet('views', 
'auth.confirm-password','auth.forgot-password','auth.login','auth.register','auth.reset-password',
'auth.verify-email','components.button','components.forms.checkbox','components.forms.input','components.layouts.app',
'components.layouts.app.header','components.layouts.app.sidebar','components.layouts.auth','components.layouts.sidebar-link','components.layouts.sidebar-three-level-link',
'components.layouts.sidebar-three-level-parent','components.layouts.sidebar-two-level-link','components.layouts.sidebar-two-level-link-parent','dashboard','settings.appearance',
'settings.partials.navigation','settings.password','settings.profile','welcome','laravel-exceptions-renderer::components.card',
